...
/*
        // Retorna somente a chave da <Key, sem o valor> primeira capital no topo da árvore
        System.out.println(treeCapitais.lowerKey( "RJ" ));

        // Retorna somente a chave da última capital no final da árvore sem o valor do lado direito
        System.out.println(treeCapitais.lastKey());

        // Retorna somente a chave da primeira capital abaixo na árvore da capital parametrizada
        System.out.println(treeCapitais.lowerKey("SC"));

        // Retorna somente a chave da primeira capital acima na árvore da capital parametrizada
        System.out.println(treeCapitais.higherKey("SC"));

        // Exibe todas as capitais declaradas em treeCapitais.put no console
        System.out.println(treeCapitais);

...
public class ExemploStreamAPI {
    ...
    public static void main(String[] args) {
       ...
       Long n = estudantes.stream().count();
 ...
 /*
        ...
        System.out.println("Todos os elemento contem W no nome? " + estudantes.stream().allMatch((elemento) -> elemento.contains("W")));
        ...
        System.out.println("nmnmnmnmnmnmnnnnmnmnmnmnmnmnmnmnmnmnmnmnmnmnmnmnmnmnmmnmmnmnmnmnmn");
